...
const OilView = ({ showAnotherComponent }) => {
    ...
    <Box sx={cardContainerStyle}>
      {showAnotherComponent && (
        <Box>
          <Appbar />
          <Box
            sx={{ display: "flex", flexFlow: "wrap", rowGap: "30px" }}
            mt={5}
          >
            <Box>
              <Box
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <p>
                    our culinary experience. Extracted from the finest sesame
                    seeds, our Gingelly Oil is a treasure trove of health
                    benefits and culinary versatility. Whether it's for
                    sautéing, frying, or seasoning, our Gingelly Oil adds a
                    delightful aroma and rich flavor to your dishes, making
